...
export const LeagueCardSkeleton = () => (
  <section className="animate-pulse space-y-5">
    <div className="mb-5 flex flex-col gap-3">
      ...
      <div className="card-surface h-32 rounded-2xl border border-white/10" />
    </div>
    <div className="mb-3 h-5 w-40 rounded bg-white/10" />

    <div className="card-surface mb-5 rounded-xl border border-white/10">
      <table className="w-full">
        <tbody>
    ...
    <div className="card-surface mt-3 rounded-xl border border-white/10">
      <table className="w-full">
        <tbody>
          {Array.from({ length: 3 }, (_, index) => (
            <tr
...
export const WeeklySurvivorSkeleton = () => (
  <section className="animate-pulse space-y-8">
    ...
    <div className="mt-6">
      <div className="mb-3 h-5 w-40 rounded bg-white/10" />
      <div className="card-surface rounded-xl border border-white/10">
        <table className="w-full">
          <tbody>
            {Array.from({ length: 3 }, (_, index) => (
              <tr
      ...
      <div className="card-surface mt-6 h-11 rounded-full border border-white/10" />
    </div>
    ...
    <div>
      ...
      <div className="space-y-3">
        {Array.from({ length: 4 }, (_, index) => (
          <div
            key={index}
            className="card-surface flex items-center gap-3 rounded-2xl border border-white/10 px-4 py-3"
          >
            <div className="h-9 w-9 rounded-full bg-white/10" />
...
export const SurvivorCardSkeleton = () => (
  <section className="animate-pulse space-y-6">
    ...
    <div className="card-surface mb-6 overflow-hidden rounded-xl border border-white/10">
      <table className="w-full">
        <tbody>
          {Array.from({ length: 8 }, (_, index) => (
            <tr
    ...
    <div className="mb-3 h-5 w-36 rounded bg-white/10" />
    <div className="card-surface max-h-40 overflow-hidden rounded-xl border border-white/10">
      <table className="w-full">
        <tbody>
          {Array.from({ length: 4 }, (_, index) => (
            <tr
